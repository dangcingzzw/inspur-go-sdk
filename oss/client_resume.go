...
func (OSSClient OSSClient) UploadFile(input *UploadFileInput, extensions ...extensionOptions) (output *CompleteMultipartUploadOutput, err error) {
	...
	output, err = OSSClient.resumeUpload(input, extensions)
	return
}
...
func (OSSClient OSSClient) DownloadFile(input *DownloadFileInput, extensions ...extensionOptions) (output *GetObjectMetadataOutput, err error) {
	...
	output, err = OSSClient.resumeDownload(input, extensions)
	return
}
