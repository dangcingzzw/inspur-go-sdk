...
type getBucketStoragePolicyOutputOSS struct {
	BaseModel
	bucketStoragePolicyOSS
}
...
type getBucketLocationOutputOSS struct {
	BaseModel
	bucketLocationOSS
}
...
type getBucketACLOutputOSS struct {
	BaseModel
	accessControlPolicyOSS
}
