...
// WithSslVerifyAndPemCerts is a configurer for OSSClient to set conf.sslVerify and conf.pemCerts.
...
// WithHeaderTimeout is a configurer for OSSClient to set the timeout period of obtaining the response headers.
...
// WithProxyUrl is a configurer for OSSClient to set HTTP proxy.
...
// WithMaxConnections is a configurer for OSSClient to set the maximum number of idle HTTP connections.
...
// WithPathStyle is a configurer for OSSClient.
...
// WithSignature is a configurer for OSSClient.
...
// WithRegion is a configurer for OSSClient.
...
// WithConnectTimeout is a configurer for OSSClient to set timeout period for establishing
...
// WithSocketTimeout is a configurer for OSSClient to set the timeout duration for transmitting data at
...
// WithIdleConnTimeout is a configurer for OSSClient to set the timeout period of an idle HTTP connection
...
// WithMaxRetryCount is a configurer for OSSClient to set the maximum number of retries when an HTTP/HTTPS connection is abnormal.
...
// WithSecurityToken is a configurer for OSSClient to set the security token in the temporary access keys.
...
// WithHttpTransport is a configurer for OSSClient to set the customized http Transport.
...
// WithRequestContext is a configurer for OSSClient to set the context for each HTTP request.
...
// WithCustomDomainName is a configurer for OSSClient.
...
// WithMaxRedirectCount is a configurer for OSSClient to set the maximum number of times that the request is redirected.
...
// WithUserAgent is a configurer for OSSClient to set the User-Agent.
...
// WithEnableCompression is a configurer for OSSClient to set the Transport.DisableCompression.
...
func (conf *config) prepareConfig() {
	...
	if conf.pathStyle && conf.signature == SignatureOSS {
...
func (conf *config) formatUrls(bucketName, objectKey string, params map[string]string, escape bool) (requestURL string, canonicalizedURL string) {
	...
	for index, key := range keys {
		...
		if conf.signature == "v4" {
			...
			isOSS := conf.signature == SignatureOSS
			if isOSS {
				prefixHeader = HEADER_PREFIX_OSS
			}
