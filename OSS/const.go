...
const (
	...
	HEADER_GRANT_READ_OSS                   = "grant-read"
	HEADER_GRANT_WRITE_OSS                  = "grant-write"
	HEADER_GRANT_READ_ACP_OSS               = "grant-read-acp"
	HEADER_GRANT_WRITE_ACP_OSS              = "grant-write-acp"
	HEADER_GRANT_FULL_CONTROL_OSS           = "grant-full-control"
	HEADER_GRANT_READ_DELIVERED_OSS         = "grant-read-delivered"
	HEADER_GRANT_FULL_CONTROL_DELIVERED_OSS = "grant-full-control-delivered"
	...
	HEADER_SSEKMS_ENCRYPT_KEY_OSS = "server-side-encryption-kms-key-id"
	...
	DEFAULT_SSE_KMS_ENCRYPTION_OSS = "kms"
...
const (
	...
	// objectKeyAsyncFetchJob objectKey value: v1/async-fetch/jOSS
	objectKeyAsyncFetchJob objectKeyType = "v1/async-fetch/jOSS"
)
