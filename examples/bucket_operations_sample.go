...
func newBucketOperationsSample(ak, sk, endpoint, bucketName, location string) *BucketOperationsSample {
	...
	return &BucketOperationsSample{OSSClient: OSSClient, bucketName: bucketName, location: location}
}
...
func (sample BucketOperationsSample) GetBucketLocation() {
	output, err := sample.OSSClient.GetBucketLocation(sample.bucketName)
	if err != nil {
		panic(err)
	}
...
func (sample BucketOperationsSample) GetBucketStorageInfo() {
	output, err := sample.OSSClient.GetBucketStorageInfo(sample.bucketName)
	if err != nil {
		panic(err)
	}
...
func (sample BucketOperationsSample) DoBucketQuotaOperation() {
	...
	_, err := sample.OSSClient.SetBucketQuota(input)
	if err != nil {
		panic(err)
	}
	...
	output, err := sample.OSSClient.GetBucketQuota(sample.bucketName)
	if err != nil {
		panic(err)
	}
...
func (sample BucketOperationsSample) DoBucketVersioningOperation() {
	output, err := sample.OSSClient.GetBucketVersioning(sample.bucketName)
	if err != nil {
		panic(err)
	}
...
func (sample BucketOperationsSample) DoBucketAclOperation() {
	...
	output, err := sample.OSSClient.GetBucketAcl(sample.bucketName)
	if err != nil {
		panic(err)
	}
...
func (sample BucketOperationsSample) DoBucketCorsOperation() {
	...
	// Setting bucket CORS
	_, err := sample.OSSClient.SetBucketCors(input)
	if err != nil {
		panic(err)
	}
	...
	output, err := sample.OSSClient.GetBucketCors(sample.bucketName)
	if err != nil {
		panic(err)
	}
	...
	_, err = sample.OSSClient.DeleteBucketCors(sample.bucketName)
	if err != nil {
		panic(err)
	}
...
func (sample BucketOperationsSample) DoBucketLifycleOperation() {
	...
	_, err := sample.OSSClient.SetBucketLifecycleConfiguration(input)
	if err != nil {
		panic(err)
	}
	...
	output, err := sample.OSSClient.GetBucketLifecycleConfiguration(sample.bucketName)
	if err != nil {
		panic(err)
	}
	...
	_, err = sample.OSSClient.DeleteBucketLifecycleConfiguration(sample.bucketName)
	if err != nil {
		panic(err)
	}
...
func (sample BucketOperationsSample) DoBucketLoggingOperation() {
	...
	_, err = sample.OSSClient.SetBucketLoggingConfiguration(input)
	if err != nil {
		panic(err)
	}
	...
	output, err := sample.OSSClient.GetBucketLoggingConfiguration(sample.bucketName)
	if err != nil {
		panic(err)
	}
...
func (sample BucketOperationsSample) DoBucketWebsiteOperation() {
	...
	_, err := sample.OSSClient.SetBucketWebsiteConfiguration(input)
	if err != nil {
		panic(err)
	}
	...
	output, err := sample.OSSClient.GetBucketWebsiteConfiguration(sample.bucketName)
	if err != nil {
		panic(err)
	}
	...
	_, err = sample.OSSClient.DeleteBucketWebsiteConfiguration(sample.bucketName)
	if err != nil {
		panic(err)
	}
...
func (sample BucketOperationsSample) DoBucketTaggingOperation() {
	...
	output, err := sample.OSSClient.GetBucketTagging(sample.bucketName)
	if err != nil {
		panic(err)
	}
	...
	_, err = sample.OSSClient.DeleteBucketTagging(sample.bucketName)
	if err != nil {
		panic(err)
	}
...
func (sample BucketOperationsSample) DeleteBucket() {
	_, err := sample.OSSClient.DeleteBucket(sample.bucketName)
	if err != nil {
		panic(err)
	}
